      ...
      <div className="flex flex-col items-center gap-4 shrink-0">
        ...
        <div className="flex w-full gap-2 mt-1">
          ...
          <button
            ...
            className="flex-1 py-2.5 px-2 bg-[var(--accent-primary)] hover:bg-[var(--accent-hover)] active:scale-95 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 duration-100 cursor-pointer shadow-md shadow-teal-500/10"
          >
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                logoType === 'none'
                  ? 'bg-[var(--accent-primary)] text-white shadow-md shadow-teal-500/10'
